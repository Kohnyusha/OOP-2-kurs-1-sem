...
namespace oop_lab12
{
    ...
    public static class Reflector
    {
        ...
        public static void nameAssembly(Type t)
        {
            ...
            StreamWriter sw = new StreamWriter(@"D:\2 курс\ООП Пацей\oop_lab12\file.txt", true);
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string pathRead1 = @"D:\2 курс\ООП Пацей\oop_lab12\invoke_1.txt";
            //string pathRead2 = @"D:\2 курс\ООП Пацей\oop_lab12\invoke_2.txt";
            //    var q = sr.ReadToEnd();
