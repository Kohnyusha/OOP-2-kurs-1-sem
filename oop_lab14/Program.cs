...
namespace oop_lab14
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (StreamWriter sw = new StreamWriter(Path.Combine(@"D:\2 курс", "flowers.json")))
            ...
            using (StreamReader sr = new StreamReader(Path.Combine(@"D:\2 курс", "flowers.json")))
            ...
            string pathXML = Path.Combine(@"D:\2 курс", "flowers.xml");
            ...
            xDoc.Load(@"D:\2 курс\flowers.xml");
            ...
            XDocument xdoc = XDocument.Load(@"D:\2 курс\flowersLINQ.xml");
