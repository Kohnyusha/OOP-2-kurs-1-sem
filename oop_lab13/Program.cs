...
namespace oop_lab13
{
    public static class KAVLog
    {
        public static void Log()
        {
            ...
            string sw = @"D:\2 курс\ООП Пацей\oop_lab13\kavlogfile.txt";
            try
            {
    ...
    public static class KAVDriveInfo
    {
        ...
        {
            StreamWriter sw = new StreamWriter(@"D:\2 курс\ООП Пацей\oop_lab13\kavlogfile.txt", true);
    ...
    public static class KAVFileInfo
    {
        ...
        {
            StreamWriter sw = new StreamWriter(@"D:\2 курс\ООП Пацей\oop_lab13\kavlog.txt", true);
            string path = @"D:\2 курс\ООП Пацей\oop_lab13\kavlog.txt";
    ...
    public static class KAVDirInfo
    {
        ...
        {
            StreamWriter sw = new StreamWriter(@"D:\2 курс\ООП Пацей\oop_lab13\kavlog.txt", true);
            string dirName = @"D:\2 курс\ООП Пацей";
    ...
    public static class KAVFileManager
    {
        ...
        {
            StreamWriter sw = new StreamWriter(@"D:\2 курс\ООП Пацей\oop_lab13\kavlog.txt", true);
            string dirName = @"D:\2 курс\ООП Пацей\oop_lab13";
            string KAVInspect = @"D:\2 курс\ООП Пацей\oop_lab13\KAVInspect";
            string KAVFiles = @"D:\2 курс\ООП Пацей\oop_lab13\KAVFiles";
            sw.WriteLine("--------------------------");
            sw.WriteLine(DateTime.Now);
            if (Directory.Exists(dirName))
            {
                ...
                // string KAVdirinfo = @"D:\2 курс\ООП Пацей\oop_lab13\KAVInspect\KAVdirinfo.txt";
                string KAVdirinfo = Path.Combine(@"D:\2 курс", "KAVdirinfo.txt");
            ...
            string KAVcopy_from = @"D:\2 курс\*txt";
            ...
            sw.WriteLine("--------------------------");
            string sourceFolder = @"D:\2 курс\ООП Пацей\oop_lab13\KAVInspect"; // исходная папка
            string zipFile = @"D:\2 курс\ООП Пацей\oop_lab13\KAVInspect.zip"; // сжатый файл
            string targetFolder = @"D:\2 курс\ооп"; // папка, куда распаковывается файл
